...
export default function TjenesterCta() {
    return (
        <div className="inner flex flex-col py-16 gap-8 lg:gap-16 bg-clr_primary_dark text-center rounded-t-3xl">
            ...
            <div className="flex flex-col flex-wrap xl:flex-row gap-8">
                <div className="flex flex-col items-center px-4 py-16 gap-16 bg-clr_black xl:flex-1">
                    <div className="flex flex-col gap-4 items-center">
                        ...
                        />
                        <h3 className="h3_text lg:text-2xl">
                            Kombinert oppfølging
                        </h3>
                        <p className="text-xs lg:text-sm max-w-md text-center">
                    ...
                    <div className="flex flex-col gap-2 text-left max-w-xs">
                        ...
                        <ul className="flex flex-col gap-2 pl-5 text-xs lg:text-sm font-semibold">
                            <li>
