...
export const coaches = [
    ...
    },
    {
        ...
        about: "Eskil er en engasjert og kunnskapsrik coach med en genuin lidenskap for trening, kosthold og livsstil. Hans spesialfelt er trening for muskelvekst, kombinert med solid erfaring innen styrketrening og vektnedgang. Eskil legger stor vekt på å skape treningsopplegg som er både effektive og motiverende, skreddersydd for å hjelpe deg nå dine personlige mål. Med sin utdanning som personlig trener fra Active Education og kurs i biomekanikk og avansert øvelsesanalyse fra AFPT, bringer Eskil en grundig forståelse av treningsprinsipper til bordet og vet hva som funker. Han er dedikert til å gi deg en positiv treningsopplevelse, hvor glede og fremgang går hånd i hånd.",
